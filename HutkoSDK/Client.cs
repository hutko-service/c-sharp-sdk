...
namespace HutkoSDK
{
    public static class Client
    {
        ...
        private static string _agent = "Hutko-c-SDK";
        ...
        /// <typeparam name="TChutkoRequest"></typeparam>
        /// <typeparam name="TChutkoResponse"></typeparam>
        /// <returns></returns>
        ...
        )
        {
            ...
            TChutkoResponse normalResponse =
                RequiredParams.ConvertResponseByContentType<TChutkoResponse>(_response, isRoot);
